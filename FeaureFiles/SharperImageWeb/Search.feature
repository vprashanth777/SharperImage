...
Feature: User should able to search an item (desktop)
 @search
 ...
 @P1
  Scenario: User should able to search an item(Desktop)
    ...
    When User search with "204875"
    Then User check that the browser title contains "VR One Plus Virtual Reality Glasses"
  ...
  Scenario: User should able to search an item from google(Desktop)
 ...
 @P1
 Scenario: User able to order Personalize item(Desktop,ND-2461)
    Given User navigate to sharperimage website
    Then User able to see the Homepage with Categories
