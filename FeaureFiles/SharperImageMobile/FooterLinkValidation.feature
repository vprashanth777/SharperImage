...
@SIRegression @Mobile
Feature: User is able to sharper Image  page footer(Mobile)
  ...
  Scenario: User should able click the "Online Return Center" and validate the content(Mobile)
    Given User navigate to sharperimage website
    When User Click the "Customer Service" by "dropdown"
  ...
  Scenario: User should able click the "Track Order" and validate the content
    Given User navigate to sharperimage website
    When User Click the "Customer Service" by "dropdown"
  ...
  Scenario: User should able click About Us and validate the content
    Given User navigate to sharperimage website
    When User Click the "Corporate" by "dropdown"
