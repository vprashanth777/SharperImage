#Author: prashanth.veldandi@valuelabs.com(QA70)
@SIRegression @Mobile
Feature: User able to buy the gift card(Mobile) (QA70)

  @P1
  Scenario: User able to buy the gift card(Mobile)
  ...
  Scenario: User able to buy the egift card(Mobile)
    Given User navigate to sharperimage website
  ...
  Scenario: User not able to buy the gift card with GiftCard(Mobile)
    Given User navigate to sharperimage website
    When User Click the button "navButton" by "id"
    And User click the link contains "More Categories"
    When User click the  Gift Guide
  ...
  Scenario: User not able to buy the gift card with promo code(Mobile)
    Given User navigate to sharperimage website
    When User Click the button "navButton" by "id"
    And User click the link contains "More Categories"
    When User click the  Gift Guide
  ...
  Scenario: User able to order item with Gift pack -Mutiple Items(Mobile S-ND-2365) QA68
    Given User navigate to sharperimage website
    When User Click the button "navButton" by "id"
    And User click the link contains "More Categories"
    When User click the  "Gadgets"
  ...
  Scenario: User able to order item with Gift pack -Single Item(Mobile S-ND-2365) QA68
    Given User navigate to sharperimage website
    When User Click the button "navButton" by "id"
    And User click the link contains "More Categories"
    When User click the  "Gadgets"
  ...
  Scenario: User not able to buy the gift card with Giftcard after adding gift card to cart(Mobile)
    Given User navigate to sharperimage website
    When User Click the button "navButton" by "id"
    And User click the link contains "More Categories"
    When User click the  "Gadgets"
  ...
  Scenario: User able to buy the egift card for others(Mobile)
    Given User navigate to sharperimage website
    When User Click the button "navButton" by "id"
    Given User login to the application
    When User click the cart
  ...
  Scenario: User able to buy corporate gift cards
    Given User navigate to sharperimage website
    When User Click the "Shopping" by "dropdown"
