#Author: prashanth.veldandi@valuelabs.com(QA 24)
@SIRegression @Mobile
Feature: Signup account Validations(Mobile)

  @Signup @P1
  Scenario: Signup account (Mobile)
  ...
  Scenario: User wants to change his/her password and login with new password successfully (Mobile)
    ...
    Scenario: User forgets his/her password to login and users forgot password feature to get new password and performs successful login with new password (Mobile)
    Given User navigate to sharperimage website
     When User Click the button "navButton" by "id"
    When User click the login
    Then User check that the browser title contains "Login"
 ...
 Scenario: Existing user trying to create account(Mobile)
    Given User navigate to sharperimage website
    When User Click the button "navButton" by "id"
    When User click the login
    Then User check that the browser title contains "Login"
