...
@CucumberOptions(
        ...
        features ={ "@target/MP1.txt"},
		
        plugin = {"com.cucumber.listener.ExtentCucumberFormatter:target/CucumberReport_ReRun.html","rerun:target/MobileFailedTest.txt"}
		

)


public class MobileFailedTest extends AbstractTestNGCucumberTests {
